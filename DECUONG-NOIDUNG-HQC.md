...
2. **Huấn luyện mô hình tái tạo chỉ trên giai đoạn thiết bị vận hành bình thường**, so sánh
   ...
   autoencoder biến phân), chọn kiến trúc bằng đường cong học và số chiều giữ lại bằng tiêu chí tách.
...
Chọn **kiến trúc** bằng **đường cong học**: huấn luyện trên lượng dữ liệu tăng dần với
...
**Tối ưu kích thước.** Chọn bằng bằng chứng thực nghiệm — **kiến trúc** bằng đường cong học, **số chiều giữ lại** bằng tiêu chí tách (sai số nhóm bất thường chia sai số nhóm bình thường). Không theo
...
| **3**<br>17–23/08 | Huấn luyện & Tối ưu mô hình *(bước 3–4)* | Xây và huấn luyện các kiến trúc tái tạo; đường cong học chọn kiến trúc; tiêu chí tách chọn số chiều; giới hạn kiểm soát 99%; điểm sức khỏe 0–100 và lớp đóng góp từng đầu đo; thực nghiệm nhiều phương án lượng tử hóa và chốt phương án. | Nghĩa | Mô hình đã huấn luyện kèm giới hạn kiểm soát; báo cáo chọn mô hình; bảng so sánh phương án lượng tử hóa; mô hình đã nén. |
...
3. Chạy **đường cong học** để chọn **kiến trúc** bằng bằng chứng thực nghiệm; chọn **số chiều giữ lại** bằng **tiêu chí tách** — vì tiêu chí phương sai cho các đáp số khác nhau và đường cong học không đặt được trần cho số chiều. Thay vì quy tắc

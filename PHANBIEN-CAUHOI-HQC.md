...
> **21 câu** (bản cập nhật: thêm câu 7 về tiêu chí chọn số chiều, đánh số lại từ câu 7 trở đi).

> Vai: giáo sư phản biện hội đồng. 21 câu, xếp từ dễ đến khó.
...
**Phạm vi của bằng chứng này:** đường cong học chọn được **kiến trúc** (tuyến tính so với phi
tuyến), nhưng **không** chọn được **số chiều giữ lại** — xem câu 7.

**Bẫy:** trả lời "vì mô hình nhỏ dễ nhúng" là **sai thứ tự lập luận** — sẽ bị hỏi ngay "vậy nếu
mạng sâu tốt hơn thì sao?". Đúng thứ tự: kiến trúc được chọn vì **bằng chứng đường cong học**;
việc nó dễ nhúng là **hệ quả**, không phải tiêu chí chọn.

### Câu 7. Mô hình giữ 6 chiều. Con số 6 chọn bằng tiêu chí nào?

**Đáp án.** Bằng **tiêu chí tách**, không bằng tiêu chí phương sai và cũng không bằng đường cong
học. Đây là điểm cần trình bày cẩn thận vì bốn tiêu chí thông dụng đều **không** cho con số 6.

**Bước 1 — các tiêu chí phương sai có tên đều lệch nhau:**

| Tiêu chí | Kết quả |
|---|---|
| Kaiser (giữ trị riêng > 1) | k = 8 |
| Điểm gãy đồ thị scree | k = 1 — không dùng được |
...
không có bậc thang rõ. **Không có "con số đúng duy nhất" theo tiêu chí phương sai.**

**Bước 2 — đường cong học không đặt được trần:**

| Số chiều | Sai số kiểm định | Chênh tương đối |
|---|---|---|
| 2 | 0,727 | 25,5% |
| **6** | 0,463 | **25,2%** |
| 10 | 0,285 | 33,5% |
...
Sai số kiểm định **giảm đều tới k = 16**, không có điểm gãy — vì ngay k = 16 vẫn còn 1,2 mẫu
trên mỗi tham số, chưa vào vùng quá khớp rõ rệt theo chỉ số này.

*Lưu ý một cái bẫy:* chênh **tuyệt đối** nhỏ dần ở k lớn (từ +0,148 xuống +0,020) là hiệu ứng
máy móc — cả hai sai số cùng tiến về không nên hiệu của chúng cũng nhỏ. Chênh **tương đối** cho
sự thật ngược lại: quá khớp **nặng dần** từ 25% lên 52%.

**Bước 3 — tiêu chí tách cho đỉnh rõ:**

| Số chiều | 2 | 4 | 5 | **6** | 7 | 8 | 10 | 16 |
|---|---|---|---|---|---|---|---|---|
| Tỉ số tách | 1,53× | 1,76× | 1,84× | **1,94×** | 1,90× | 1,89× | 1,29× | 1,12× |

Có đỉnh rõ tại k = 6, rồi sụp nhanh.

**Bước 4 — kiểm độ nhạy.** Báo động giả ở k = 4–8 nằm trong 0,94–1,21% và tỉ số tách trong
1,76–1,94×. Kết luận **không nhạy** với lựa chọn cụ thể trong khoảng k = 5–8 — quan trọng, vì
nếu chỉ k = 6 hoạt động mà k = 5 hay 7 thì sập thì kết quả là ngẫu nhiên.

**Nguyên tắc gói lại:** với mô hình dùng để **nén dữ liệu**, số chiều chọn theo phương sai giữ
được. Với mô hình dùng để **phát hiện bất thường**, số chiều chọn theo khả năng **tách** — và
hai tiêu chí cho hai đáp số khác nhau. Ở đây tiêu chí phương sai nói 8–13, tiêu chí tách nói 6;
chọn 6 vì mục đích là phát hiện, không phải nén.

**Bẫy:** trả lời "giữ 6 chiều vì đủ 90% phương sai" là **sai số học** (90% ứng với k = 11) và
sai cả về nguyên tắc — sẽ bị truy ngay.

### Câu 8. Tại sao sai số tái tạo nhỏ nhất không phải tiêu chí chọn mô hình?
...
### Câu 9. Cửa sổ nền được chọn thế nào? Vì sao không lấy đoạn đầu chuỗi dữ liệu?
...
### Câu 10. Giới hạn cảnh báo tính thế nào? "Mức tin cậy 99%" là kết quả hay đầu vào?
...
### Câu 11. Vì sao không dùng công thức "trung bình + 3 độ lệch chuẩn" cho đơn giản?
...
### Câu 12. Công thức khớp mô-men dùng dữ liệu gì làm đầu vào? Vì sao không dùng chính các giá trị sai số đã đo?
...
### Câu 13. Vì sao cần hai thống kê phát hiện? Một cái không đủ sao?
...
## PHẦN C — Kết quả và phần nhúng (câu 14–17)

### Câu 14. Lớp giải thích hoạt động thế nào? Làm sao mô hình biết ổ đỡ nào có vấn đề khi không ai dạy nó?
...
### Câu 15. Lượng tử hóa làm thế nào? Có phải chỉ đổi số thực sang số nguyên?
...
### Câu 16. Vì sao phải đo ba chỉ số khi so sánh các phương án nén? Một chỉ số độ chính xác không đủ sao?

**Đáp án.** Không đủ — và đây là điểm phương pháp quan trọng nhất của bước nén.

Xem phương án cuối bảng ở câu 15: khả năng xếp hạng **0,8211**, chỉ giảm 1% so bản gốc — nhìn
...
### Câu 17. Mô hình sau nén chỉ 312 byte. Vậy nén để làm gì khi thiết bị có hàng trăm megabyte?
...
1. **Đi trọn quy trình thiết kế** — huấn luyện, nén, xuất tham số, suy luận trên thiết bị, đo
   tài nguyên.
2. **Một thất bại thật để phân tích** (câu 15) — có giá trị phương pháp cao hơn một kết quả
...
## PHẦN D — Câu hỏi khó (câu 18–21)

### Câu 18. Tỉ lệ báo động giả 1,08% đo trên chính giai đoạn dùng để huấn luyện. Đó không phải đánh giá trên dữ liệu độc lập — con số này có ý nghĩa gì?
...
### Câu 19. Trên tập đánh giá, 93% mẫu được gán nhãn "bình thường" cũng vượt giới hạn cảnh báo. Vậy mô hình có phân biệt được gì không?
...
### Câu 20. Nhãn trên tập đánh giá do ai gán? Nếu sinh từ chính mô hình thì lập luận có vòng tròn không?
...
### Câu 21. Đề tài nói "cảnh báo sớm", nhưng sớm bao nhiêu? Con số đó ở đâu?
...
1. **Phân biệt "chọn" với "đạt".** Mức tin cậy, số chiều giữ lại, cửa sổ nền là **lựa chọn có
   tiêu chí có tên**; báo động giả, khả năng xếp hạng, thời gian cảnh báo là **kết quả đo**. Lẫn hai loại
   này là chỗ bị truy nhiều nhất.

2. **Nêu giới hạn trước khi bị hỏi.** Ba giới hạn phải chủ động nêu: báo động giả đo trên chính
   giai đoạn huấn luyện (câu 18), cửa sổ nền quá hẹp làm mô hình quá nhạy (câu 19), chưa đo được
   thời gian cảnh báo trước (câu 21). Nêu trước thì thành "hiểu rõ phương pháp"; bị hỏi mới nói
   thì thành "che".
